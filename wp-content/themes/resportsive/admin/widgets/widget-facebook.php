...
add_action( 'widgets_init', 'resport_facebook_load_widgets' );

function resport_facebook_load_widgets() {
	register_widget( 'resport_facebook_widget' );
}

class resport_facebook_widget extends WP_Widget {

	/**
	 * Widget setup.
	 */
	function resport_facebook_widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'resport_facebook_widget', 'description' => __('A widget that displays a Facebook Like Box', 'resport_facebook_widget') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'resport_facebook_widget' );

		/* Create the widget. */
		$this->WP_Widget( 'resport_facebook_widget', __('Resportsive: Facebook Like Box', 'resport_facebook_widget'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => 'Facebook', 'width' => 300, 'height' => 260, 'faces' => 'on');
