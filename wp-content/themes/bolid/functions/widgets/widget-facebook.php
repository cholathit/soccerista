...
class Facebook_Widget extends WP_Widget {
	...
	function Facebook_Widget()
	{
		...
		$this->WP_Widget('facebook-like-widget', 'Vergo - Facebook Box', $widget_ops, $control_ops);
	}
	...
	function widget($args, $instance)
	{
		...
		if($page_url): ?>
		<iframe src="http://www.facebook.com/plugins/likebox.php?href=<?php echo urlencode($page_url); ?>&amp;width=<?php echo $width; ?>&amp;colorscheme=<?php echo $color_scheme; ?>&amp;show_faces=<?php echo $show_faces; ?>&amp;border_color=%23dddddd&amp;stream=<?php echo $show_stream; ?>&amp;header=<?php echo $show_header; ?>&amp;height=<?php echo $height; ?>" scrolling="no" frameborder="0" style="border-color:#dddddd; padding:-1px; overflow:hidden; width:<?php echo $width; ?>px; height: <?php echo $height; ?>px;" allowTransparency="true"></iframe>
        </div>
		<?php endif;
	...
	{
		$defaults = array('title' => 'Find us on Facebook', 'page_url' => '', 'width' => '325', 'color_scheme' => 'light', 'show_faces' => 'on', 'show_stream' => false, 'show_header' => false);
