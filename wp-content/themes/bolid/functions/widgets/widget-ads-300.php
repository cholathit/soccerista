...
class AdWidget_300 extends WP_Widget {
	...
	function AdWidget_300() {
		...
		parent::WP_Widget(false, __('Vergo - Ads Widget 300px', 'vergo'),$widget_ops);      
	}
	...
	function form($instance) {    
		...
		?>
        <p>
            <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title (optional):','vergo'); ?></label>
            <input type="text" name="<?php echo $this->get_field_name('title'); ?>" value="<?php echo $title; ?>" class="widefat" id="<?php echo $this->get_field_id('title'); ?>" />
        </p>
		<p>
            <label for="<?php echo $this->get_field_id('adcode'); ?>"><?php _e('Ad Code:','vergo'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('href'); ?>"><?php _e('Link URL:','vergo'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('alt'); ?>"><?php _e('Alt text:','vergo'); ?></label>
