<div id="comments">
	...
	<?php if ( have_comments() ) : ?>
		<h2 class="comments">
			<?php
			printf( _n( 'One Comment', '%1$s Comments', get_comments_number(), 'mvp-text' ),
...
<?php comment_form(
	array(
		'title_reply' => '<h2 class="comments">' . __( 'Leave a Reply', 'mvp-text' ) . '</h2>',
		'title_reply_to' => '<h2 class="comments">' . __( 'Leave a Reply', 'mvp-text' ) . '</h2>',
	)
); ?>
